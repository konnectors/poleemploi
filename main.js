...
/* harmony import */ var cozy_clisk_dist_contentscript_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(33);
/* harmony import */ var ky__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52);
...
_cozy_minilog__WEBPACK_IMPORTED_MODULE_1___default().enable('poleemploiCCC')
...
class PoleemploiContentScript extends cozy_clisk_dist_contentscript__WEBPACK_IMPORTED_MODULE_0__.ContentScript {
  async onWorkerReady() {
  ...
  async computeAttestation() {
    ...
    const blob = await ky__WEBPACK_IMPORTED_MODULE_3__["default"].get(
      ...
      .blob()
    const dataUri = await (0,cozy_clisk_dist_contentscript_utils__WEBPACK_IMPORTED_MODULE_2__.blobToBase64)(blob)
